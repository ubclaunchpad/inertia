// Code generated by fileb0x at "2020-10-19 17:05:39.399109 +0800 CST m=+0.001507684" from config file "b0x.yml" DO NOT EDIT.
// modification hash(57328e4b4c3bb869c76f3f846eecf0c4.5ead88036f2e7030b622ddd5d55e845b)
...
func init() {
	...
	f, err = FS.OpenFile(CTX, "scripts/daemon-down.sh", os.O_RDWR|os.O_CREATE|os.O_TRUNC, 0777)
	if err != nil {
		panic(err)
	}

	_, err = f.Write(FileScriptsDaemonDownSh)
	if err != nil {
		panic(err)
	}
	...
	f, err = FS.OpenFile(CTX, "scripts/daemon-up.sh", os.O_RDWR|os.O_CREATE|os.O_TRUNC, 0777)
	if err != nil {
		panic(err)
	}

	_, err = f.Write(FileScriptsDaemonUpSh)
	if err != nil {
		panic(err)
	}
	...
	f, err = FS.OpenFile(CTX, "scripts/docker.sh", os.O_RDWR|os.O_CREATE|os.O_TRUNC, 0777)
	if err != nil {
		panic(err)
	}

	_, err = f.Write(FileScriptsDockerSh)
	if err != nil {
		panic(err)
	}
	...
	f, err = FS.OpenFile(CTX, "scripts/inertia-down.sh", os.O_RDWR|os.O_CREATE|os.O_TRUNC, 0777)
	if err != nil {
		panic(err)
	}

	_, err = f.Write(FileScriptsInertiaDownSh)
	if err != nil {
		panic(err)
	}
	...
	f, err = FS.OpenFile(CTX, "scripts/keygen.sh", os.O_RDWR|os.O_CREATE|os.O_TRUNC, 0777)
	if err != nil {
		panic(err)
	}

	_, err = f.Write(FileScriptsKeygenSh)
	if err != nil {
		panic(err)
	}
	...
	f, err = FS.OpenFile(CTX, "scripts/token.sh", os.O_RDWR|os.O_CREATE|os.O_TRUNC, 0777)
	if err != nil {
		panic(err)
	}

	_, err = f.Write(FileScriptsTokenSh)
	if err != nil {
		panic(err)
	}
