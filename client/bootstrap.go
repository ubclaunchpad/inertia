...
func clientBootstrapDaemonDownSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "client/bootstrap/daemon-down.sh", size: 251, mode: os.FileMode(420), modTime: time.Unix(1526365343, 0)}
...
func clientBootstrapDockerSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "client/bootstrap/docker.sh", size: 921, mode: os.FileMode(493), modTime: time.Unix(1526365343, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func clientBootstrapTokenSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "client/bootstrap/token.sh", size: 292, mode: os.FileMode(493), modTime: time.Unix(1527376050, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
