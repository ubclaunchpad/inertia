...
func clientBootstrapDaemonUpSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "client/bootstrap/daemon-up.sh", size: 1297, mode: os.FileMode(493), modTime: time.Unix(1515346025, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func clientBootstrapDockerSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "client/bootstrap/docker.sh", size: 962, mode: os.FileMode(493), modTime: time.Unix(1515277351, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
