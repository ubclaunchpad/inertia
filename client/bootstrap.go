...
func clientBootstrapDaemonUpSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "client/bootstrap/daemon-up.sh", size: 1437, mode: os.FileMode(493), modTime: time.Unix(1520234537, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func clientBootstrapTokenSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "client/bootstrap/token.sh", size: 347, mode: os.FileMode(493), modTime: time.Unix(1520183597, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
