...
func clientBootstrapDaemonUpSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "client/bootstrap/daemon-up.sh", size: 1707, mode: os.FileMode(493), modTime: time.Unix(1525062084, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func clientBootstrapDockerSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "client/bootstrap/docker.sh", size: 921, mode: os.FileMode(493), modTime: time.Unix(1524904851, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
