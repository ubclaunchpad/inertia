...
func clientBootstrapDaemonUpSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "client/bootstrap/daemon-up.sh", size: 1518, mode: os.FileMode(493), modTime: time.Unix(1521406584, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func clientBootstrapTokenSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "client/bootstrap/token.sh", size: 309, mode: os.FileMode(493), modTime: time.Unix(1521352687, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
